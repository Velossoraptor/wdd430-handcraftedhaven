    ...
    <div className="p-6 md:p-10 space-y-8 bg-gray-50 min-h-screen font-sans">
      ...
      <header className="pb-4 border-b">
        ...
        <p className="text-gray-600 mt-1">
          Manage your public bio and account preferences.
        </p>
      </header>

      <form
        onSubmit={handleSubmit}
        className="bg-white p-8 rounded-xl shadow-lg space-y-10"
      >
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <input
                ...
                className="file:py-2 file:px-4 file:rounded-full file:bg-amber-50 file:text-amber-700"
              />
              {imageFile && (
        ...
        <div className="space-y-6 pt-6 border-t border-gray-100">
          <h2 className="text-xl font-semibold border-b pb-2 flex items-center">
            <Settings className="w-5 h-5 mr-3 text-gray-400" /> Account
            Preferences
          </h2>
          ...
          <label className="flex items-center">
            <input
              type="checkbox"
              name="emailNewOrder"
              checked={profileData.emailNewOrder}
              onChange={handleChange}
              className="h-4 w-4"
            />
          ...
          <label className="flex items-center">
            <input
              type="checkbox"
              name="emailNewReview"
              checked={profileData.emailNewReview}
              onChange={handleChange}
              className="h-4 w-4"
            />
        ...
        <div className="pt-8 border-t border-gray-100 flex justify-end">
          <button
            type="submit"
            disabled={isSaving}
            className="bg-amber-600 hover:bg-amber-700 text-white py-3 px-6 rounded-lg"
          >
