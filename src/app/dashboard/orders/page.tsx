...
const mockOrders: Order[] = [
  ...
  { id: 'HH1004', customerName: 'Olivia M.', items: 1, total: 120.0, status: 'Processing', date: '2025-11-18' },
  { id: 'HH1003', customerName: 'Noah P.', items: 3, total: 88.5, status: 'Shipped', date: '2025-11-17' },
  { id: 'HH1002', customerName: 'Emma T.', items: 1, total: 32.75, status: 'Delivered', date: '2025-11-16' },
  { id: 'HH1001', customerName: 'Chris B.', items: 4, total: 155.0, status: 'Delivered', date: '2025-11-15' },
];
...
const getStatusBadge = (status: Order['status']) => {
  switch (status) {
    ...
    case 'Processing':
      return <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-blue-50 text-blue-800">Processing</span>;
    case 'Shipped':
      return <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-green-50 text-green-900">Shipped</span>;
    case 'Delivered':
      return <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-gray-100 text-gray-700">Delivered</span>;
  }
};
