  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
        ...
        <Link
          href="/"
          className="mt-6 text-amber-600 hover:text-amber-800 underline"
        >
          Go to Homepage
        </Link>
      </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-sm text-gray-500 flex items-center">
                <Star className="w-4 h-4 mr-2" /> {profile.averageRating} Avg
                Rating
              </p>
            </div>
          ...
          <div className="lg:col-span-2 mt-6 lg:mt-0 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h2 className="text-2xl font-bold mb-4 flex items-center">
                <Shirt className="w-6 h-6 mr-2 text-amber-600" /> Featured
                Products
              </h2>
