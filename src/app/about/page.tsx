          ...
          <div className="bg-white/80 dark:bg-gray-800/70 rounded-xl shadow-lg p-8 md:p-12">
            <header className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300">
                ...
                artisans and makers. We curate unique, high-quality handmade
                goods and connect creators with customers who value craft.
              </p>
            </header>
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-2 items-start">
              <article className="prose max-w-none dark:prose-invert">
                ...
                <p>
                  ...
                  responsibly made products. We prioritize fairness,
                  transparency, and sustainability in every connection we
                  facilitate.
                </p>
